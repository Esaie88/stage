...
public class CustomFieldDDMFormFieldRenderer implements DDMFormFieldRenderer {

	public CustomFieldDDMFormFieldRenderer() {
	...
	protected String getFieldNamespace(
		...
		return StringUtil.extractLast(
				fieldsDisplayValue, CustomFieldDDMImpl.INSTANCE_SEPARATOR);
	}
	...
	protected String getFieldsDisplayValue(
		...
		if (fields != null) {
			Field fieldsDisplayField = fields.get(CustomFieldDDMImpl.FIELDS_DISPLAY_NAME);
		...
		return ParamUtil.getString(
				request, CustomFieldDDMImpl.FIELDS_DISPLAY_NAME, defaultFieldsDisplayValue);
	}
	...
	protected String[] getFieldsDisplayValues(String fieldDisplayValue) {
		...
		for (String value : StringUtil.split(fieldDisplayValue)) {
			String fieldName = StringUtil.extractFirst(
					value, CustomFieldDDMImpl.INSTANCE_SEPARATOR);
...
//	 * @see com.liferay.taglib.util.ThemeUtil#includeFTL
	...
	private static final String _TPL_PATH =
			"com/liferaysavvy/ddm/dependencies/";

	private static final Log _log = LogFactoryUtil.getLog(
			CustomFieldDDMFormFieldRenderer.class);
